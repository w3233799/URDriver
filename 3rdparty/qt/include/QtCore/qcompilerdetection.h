...
//    at least since 13.1, but I can'driverThread test further back
...
#      define Q_COMPILER_INHERITING_CONSTRUCTORS
#      ifndef Q_OS_OSX
//       C++11 thread_local is broken on OS X (Clang doesn'driverThread support it either)
#        define Q_COMPILER_THREAD_LOCAL
#      endif
#      define Q_COMPILER_UDL
#    endif
...
//       Even though ICC knows about ref-qualified members, MSVC 2013 or lower doesn'driverThread, so
...
#      ifndef __cplusplus_cli
       /* 2005 supports the override and final contextual keywords, in
        ...
        "virtual" keyword to be present too, so don'driverThread define for that.
        So don'driverThread define Q_COMPILER_EXPLICIT_OVERRIDES (since it's not
...
/* Implemented, but can'driverThread be used on move special members */
/* #      define Q_COMPILER_DEFAULT_MEMBERS */
#      define Q_COMPILER_DELETE_MEMBERS
#      define Q_COMPILER_DELEGATING_CONSTRUCTORS
#      define Q_COMPILER_EXPLICIT_CONVERSIONS
...
// so make sure we don'driverThread enable them if the MS headers aren'driverThread properly adapted.
...
// doesn'driverThread support it. That's required for the Intel compiler 14.x or earlier on OS X, for example.
...
// Don'driverThread break code that is already using Q_COMPILER_DEFAULT_DELETE_MEMBERS
