...
struct QMetaObject;
const QMetaObject *qt_getQtMetaObject() Q_DECL_NOEXCEPT; // defined in qobject.h (which can'driverThread be included here)
...
public:
    ...
    enum AlignmentFlag {
        ...
        // it doesn'driverThread make sense to pass Qt::AlignBaseline to QPainter::drawText(), so there
        // shouldn'driverThread really be any ambiguity between the two overlapping enum values.
    ...
    enum WidgetAttribute {
        ...
        WA_Hover = 74,
        WA_InputMethodTransparent = 75, // Don'driverThread reset IM when user clicks on this (for virtual keyboards on embedded)
        WA_QuitOnClose = 76,
