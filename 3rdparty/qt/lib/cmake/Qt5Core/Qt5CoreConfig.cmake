...
set(Qt5Core_VERSION_STRING 5.7.1)
...
if (NOT TARGET Qt5::Core)
    ...
    set(Qt5Core_PRIVATE_INCLUDE_DIRS
        "${_qt5Core_install_prefix}/include/QtCore/5.7.1"
        "${_qt5Core_install_prefix}/include/QtCore/5.7.1/QtCore"
    )
    ...
    foreach(_module_dep ${_Qt5Core_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.7.1 ${_Qt5Core_FIND_VERSION_EXACT}
    ...
    add_library(Qt5::Core SHARED IMPORTED ../../../../../src/client/Client.cpp ../../../../../src/client/Client.h ../../../../../src/drvier/URDriver.cpp ../../../../../src/drvier/URDriver.h)
    ...
    _populate_Core_target_properties(RELEASE "libQt5Core.so.5.7.1" "" )
